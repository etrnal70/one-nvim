...
LspDiagnosticsFloatingError          = { fg = hue_5 , bg = none },
LspDiagnosticsFloatingWarning        = { fg = hue_6_2 , bg = none },
LspDiagnosticsFloatingInformation    = { fg = hue_1 , bg = none },
LspDiagnosticsFloatingHint           = { fg = hue_4 , bg = none },
